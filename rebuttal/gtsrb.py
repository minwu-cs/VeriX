import sys
# sys.path.append("/barrett/scratch/haozewu/veriX/Marabou/")
import time
...
import os
result_dir = 'index-%d-%s-%ds-%s-linf%g' % (index, model_name, TIMEOUT, traverse, epsilon)
...
marabou_time_text = '%s-%ds-heuristic-linf%g-marabou-time.txt' % (model_name, TIMEOUT, epsilon)
